...
import Product from "@components/product/layout-testing";
import FilterButtons from "@components/filter-buttons";
import { flatDeep } from "@utils/methods";
import { SectionTitleType, ProductType } from "@utils/types";
import InfoSignupModal from "@components/modals/infosignup-modal";
...
const ExploreProductArea = ({ className, space, data }) => {
    ...
    const [showInfoSignupModal, setShowInfoSignupModal] = useState(false);
    const handleInfoSignupModal = () => {
        setShowInfoSignupModal((prev) => !prev);
    };
    ...
    return (
        ...
        >
            <div className="container">
                ...
                <InfoSignupModal
                    show={showInfoSignupModal}
                    handleModal={handleInfoSignupModal}
                />
            </div>
        </div>
    );
